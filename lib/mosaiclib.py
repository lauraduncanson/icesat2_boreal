...
set_quebes_fires  = [1380, 1381, 1382, 1383, 1384, 1385, 1386, 1322, 1323, 1324, 1325, 1326, 1327, 1261, 1262, 1263, 1264, 1265]
...
ALL_TEST_TILES = VAL_TILES_TO_ADD_TO_TEST_TILES + \
                set_quebes_fires + set_brooks + set_seward + \
